...
public class LeaveController {
    ...
    public ResponseEntity<LeaveForm> applyLeave(
        ...
        LeaveForm savedLeave = leaveService.applyLeave(leaveForm);  // Save the leave form
...
public ResponseEntity<LeaveForm> managerApplyLeave(
    ...
    leaveForm.setUser(userService.getUser(userId));
    LeaveForm savedLeave = leaveService.applyLeave(leaveForm);
